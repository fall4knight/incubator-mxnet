...
bool SliceChannelOpShape(std::vector<TShape> *in_shape,
...
bool SliceChannelInferType(std::vector<int> *in_type,
...
void SliceChannelForward(const OpContext &ctx,
...
void SliceChannelBackward(const OpContext &ctx,
